...
def extract_job(html):
    # jobTitle = html.find("h2", {"class": "jobTitle"}).find("span").string
    jobTitle = html.select_one('.jobTitle>span').string
    ...
    # job_id = html["data-jk"]
    # print(job_id)
    # return  {'title': jobTitle, 'company': company, 'location': 'location', "link": f"https://www.indeed.com/viewjob?jk={job_id}"}
